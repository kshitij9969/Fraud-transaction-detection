...
This python code uses gradient boost to classify transactions as fraud or valid. 
...
# X_train.to_csv(path_or_buf='/content/Xtrain.csv')

X_test

X_training = X_train
X_training['isFraud'] = y_train
